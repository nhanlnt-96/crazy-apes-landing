    ...
    <Container fluid className="pre-sale-comp">
      <Container className="pre-sale-comp-container">
        <Row className="pre-sale-content">
          <h6 data-aos="fade-up" className="content">These are <span
            className="content">the 4 Pre-Sale Ape Winners</span> that won 2 ETH
        ...
        <Row className="animate-arrow">
          <div data-aos="zoom-in" className="item-arrow">
